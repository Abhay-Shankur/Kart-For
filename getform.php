<?php
    if (isset($_REQUEST['parent']) && empty($_REQUEST['alertType']) && empty($_REQUEST['alertMsg'])) {
        echo "<div id='overlay-form' class='openAnimationClass'>
        <div id='close' onclick='window.open(location.href,`_top`)'>
            ...
            <div id='customer-panel'>
                <div id='panels'>
                    ...
                    <div id='rightpanel'>
                        ...
                        <div id='panel-body'>
                            <!-- Login Form -->
                            <form id='customer-login-form' class='form active-form' method='POST' action='{$_REQUEST['parent']}'>
                                <!-- Form Title -->
                            ...
                            <!-- Sign Up Form -->
                            <form id='customer-signup-form' class='form' method='POST' action='{$_REQUEST['parent']}'>
                                <!-- Form Title -->
                                <div class='form-title'>
    ...
    <!-- OverLay Form Closing -->
    ...
    } else if (isset($_REQUEST['parent']) && !empty($_REQUEST['alertType']) && !empty($_REQUEST['alertMsg'])) {
        ...
        echo "<div id='overlay-form' style='width: 100%;height: 100%;opacity: 1;'>
        <div id='close' onclick='window.open(location.href,`_top`)'>
            <i class='material-icons'>close</i>
        </div>
        <div class='content-area'>
            ...
            <div class='alerts'>
                <div id='{$_REQUEST['alertType']}' class='alert alert-{$_REQUEST['alertType']}'>
                    {$_REQUEST['alertMsg']}
                </div>
            </div>
