        ...
        <div class='heading'>
            ...
            <div id='heading-content-3'>
                <div class='contact-logos'>
                    <!-- Facebook -->
                    <a class='contact-logos-icon' style='color: #3b5998;' href='https://www.facebook.com/' role='button'>
                        <i class='fab fa-facebook-f fa-lg me-3'></i>
                    </a>

                    <!-- Twitter -->
                    <a class='contact-logos-icon' style='color: #55acee;' href='https://twitter.com/?lang=en' role='button'>
                        <i class='fab fa-twitter fa-lg me-3'></i>
                    </a>

                    <!-- Whatsapp -->
                    <a class='contact-logos-icon' style='color: #25d366;' href='https://wa.me/918600679220?text=' role='button'>
                        <i class='fab fa-whatsapp fa-lg me-3'></i>
                    </a>

                    <!-- Instagram -->
                    <a class='contact-logos-icon' style='color: #ac2bac;' href='https://www.instagram.com/' role='button'>
                        ...
                        <li>
                            <div class='lgscrn-menu dropdown'>
                                <button id='button-category' onclick='openTopLinks(this.id)'>
                                    <i class='fas fa-list-alt'>  Category</i>
                                </button>
                        ...
                        <li>
                            <div class='lgscrn-menu'>
                                <button id='button-prime' onclick='openTopLinks(this.id)'>
                                    <i class='fas fa-user-tag'> Prime</i>
                                </button>
                            </div>
                        </li>
                    </ul>
            ...
            <ul>
                ...
                <li>
                    <div class='sidemenu-content' id='sidemenu-content-5' onclick='openSideLinks(this);'>
                        <div class='sidemenu-content-icon'><i class='material-icons'>&#xe8a1;</i></div>
                        <div class='sidemenu-content-text'>Pay Kart</div>
                    </div>
                </li>
                <li>
